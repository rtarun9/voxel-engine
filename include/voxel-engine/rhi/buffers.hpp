...
// Encapsulation over structured buffer and a upload buffer.
// Provides function to copy data from the upload buffer to structured buffer.
struct upload_structured_buffer_t
{
    ...
    u32 m_default_resource_srv_index{};
};
